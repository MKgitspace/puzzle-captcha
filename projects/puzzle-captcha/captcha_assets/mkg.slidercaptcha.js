(function() {
    ...
    _proto.initImg = function() {
        ...
        img.setSrc = function() {
            ...
            if (isIE) { // IE browser cannot cross domain through img.crossOrigin, use ajax to get image blob and then convert it to dataURL for display
